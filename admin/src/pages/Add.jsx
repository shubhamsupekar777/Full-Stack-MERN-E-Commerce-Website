    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3 '>
      ...
      <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
        ...
        <div>
          ...
          <input onChange={(e)=>setPrice(e.target.value)} value={price} className='w-full px-3 py-2 sm:w-[120px]' type="Number" placeholder='250Rs' />
        </div>
      </div>
      <div>
        ...
        <div className='flex gap-3'>
          ...
          <div onClick={()=>setSizes(prev=>prev.includes("XLL") ? prev.filter(item=>item !=="XLL"):[...prev,"XLL"])}>
            <p className={`${sizes.includes("XLL") ? "bg-pink-100" : "bg-slate-100"} px-3 py-1 cursor-pointer`}>XLL</p>
          </div>
        </div>
      </div>
...
//       // ✅ Adjust this if backend doesn't return success
...
//             }}>
//               <p className={`${sizes.includes(size) ? "bg-pink-100" : "bg-slate-100"} px-3 py-1 cursor-pointer`}>{size}</p>
//             </div>
//           ))}
//         </div>
//       </div>
